...
<HeaderLayout navigationAction={<Link startIcon={<ArrowLeft />} to="/">
        ...
        Paramètres
      </Button>}  title="Notifications" subtitle="Gestion des notificatons au sein du LMS" as="h2" />
...
<Box padding={1} marginBottom={9}>
        <ContentBox
          ...
          subtitle={formatMessage({
            id: 'informa',
            defaultMessage:
              "Activer ou Désactiver les notifications selon les différentes catégories du LMS",
          })}
